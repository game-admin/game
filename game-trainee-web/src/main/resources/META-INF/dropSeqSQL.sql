...
DROP SEQUENCE game."kursvoraussetzung_KURSVORAUSSETZID_seq" CASCADE;

DROP SEQUENCE game."quiz_QID_seq" CASCADE;

DROP SEQUENCE game."quizbeantwortung_QBEID_seq" CASCADE;

DROP SEQUENCE game."quizvoraussetzung_QUIZVORAUSSETZID_seq" CASCADE;

DROP SEQUENCE game."trainee_MITID_seq" CASCADE;

DROP SEQUENCE game."voraussetzung_VORAUSSETZID_seq" CASCADE;
